...
const Home = () => {
  ...
  useEffect(() => {
    fetchBooks(1).then((data) => setBooks(data.books));
            ...
            {threeNews.map((threenews) => {
              return (
                <div className="news__content container-fluid row col-lg-4 col-md-12 col-12">
                  <div
                    onClick={() =>
                      navigate("/newscatalog/news/" + threenews.id)
                    }
                    key={threenews.id}
          ...
          <div className="books__content container-fluid row justify-content-center align-items-center m-auto">
            {books.map((book) => {
              return (
                <div
                  key={book.id}
                  className="book__block column center col-lg-3 col-md-6 col-12"
                >
                  <div
